...
```javascript
import ltrimN from 'https://cdn.jsdelivr.net/gh/stdlib-js/string-left-trim-n@v0.2.3-deno/mod.js';
```
...
[@stdlib/string/right-trim-n]: https://github.com/stdlib-js/string-right-trim-n/tree/deno
