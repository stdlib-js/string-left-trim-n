...
```javascript
ltrimN = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/string-left-trim-n@v0.2.3-umd/browser.js' )
```
...
[@stdlib/string/right-trim-n]: https://github.com/stdlib-js/string-right-trim-n/tree/umd
